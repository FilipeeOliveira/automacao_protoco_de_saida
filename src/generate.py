...
LAST_CONTROL_FILE = os.path.join(os.path.dirname(__file__), "cache_control", "last_control.txt")
TEMPLATE_PATH = os.path.join(os.path.dirname(__file__), "template_base", "TERMO_DE_ENTREGA_DE_EQUIPAMENTO.xlsx")
